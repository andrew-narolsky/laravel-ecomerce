        ...
        <div class="container-fluid content-top-gap">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb my-breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Создание категории') }}</li>
                </ol>
            </nav>
            <!-- //breadcrumbs -->
                ...
                <div class="card card_border py-2 mb-4">
                    ...
                    {{Form::open([
                        ...
                        <div class="form-check check-remember check-me-out mb-4">
                            <input type="checkbox" class="form-check-input checkbox" id="exampleStatus" name="is_featured">
                            <label class="form-check-label checkmark" for="exampleStatus">{{ __('Показать на главной') }}</label>
                        </div>
                        <div class="form-group">

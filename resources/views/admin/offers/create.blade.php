        ...
        <div class="container-fluid content-top-gap">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb my-breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('Создание товарного предложения') }}</li>
                </ol>
            </nav>
            <!-- //breadcrumbs -->
            ...
            <section class="forms">
                ...
                <div class="card card_border py-2 mb-4">
                    ...
                    <div class="cards__heading flex__box">
                        <h3>{{ __('Создание товарного предложения') }}</h3>
                    </div>
                    <div class="card-body">

                    {{Form::open([
                        'route'	=> ['offers.store', $product],
                        'files'	=>	true
                    ])}}
                        <div class="form-row">
                            <div class="form-group col-lg-12">
                                ...
                                <div class="mb-4">
                                    <label for="exampleInputTitle" class="input__label">{{ __('Цена') }}</label>
                                    <input type="text" class="form-control input-style" name="price" value="{{ old('price') }}"
                                           aria-describedby="titleHelp" placeholder="{{ __('Цена') }}">
                                    @error('price')
